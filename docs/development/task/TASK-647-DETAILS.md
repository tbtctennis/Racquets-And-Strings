...
**After.** Migration framework invokes reconciliation and blocks completion on unexplained drift.

**Acceptance.** Migration framework invokes reconciliation and blocks completion on unexplained drift.
