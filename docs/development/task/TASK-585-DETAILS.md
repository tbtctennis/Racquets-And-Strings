...
| **TLDR**       | A consent banner precedes analytics |
| **Status**     | completed                                 |
| **Tags**       | UI, Auth, QA                        |
| **Sprint**     | DC06 Spiderman                      |
| **Legacy ids** | D7-SW-T11                           |
| **Blocked by** | None                                |

## Detail

**Today.** Analytics fires before any consent is given

**After.** A consent banner precedes analytics

**Acceptance.** No analytics call fires before consent · the choice is remembered
