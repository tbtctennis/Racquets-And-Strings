...
**After.** Authorized correction validates state, records actor/reason/before/after, recomputes atomically.

**Acceptance.** Authorized correction validates state, records actor/reason/before/after, recomputes atomically.
