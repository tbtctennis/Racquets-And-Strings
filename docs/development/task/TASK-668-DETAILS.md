...
| -------------- | --------------------------------------------------------------------- |
| **Task id**    | TASK-668                                                              |
| **Title**      | Mobile offline, sync, deep-link, notification, and device QA contract |
| **TLDR**       | Depends on the platform decision.                                     |
| **Status**     | backlog                                                               |
| **Tags**       | Planning, QA                                                          |
| **Sprint**     | backlog                                                               |
| **Legacy ids** | BLG0066                                                               |
...
**After.** Depends on the platform decision.

**Acceptance.** Depends on the platform decision.
